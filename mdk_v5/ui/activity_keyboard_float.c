...
/** Screen_KeyBoard_Int */
gt_obj_st * Screen_KeyBoard_Float = NULL;
...
int JudgmentUPAndLowerLimit(double flData,Limit limit)
{
	
	if(flData>=0.0)
	{
		if((flData>=limit.lowerlimit)&&(flData<=(limit.toplimit+0.0000009)))
		{	
			return 0;
		}
		else 
...
static void Confirm(gt_event_st * e) {
	//storage speed number	
	char buffer[50];
	int flag;

	
	flag = JudgmentUPAndLowerLimit(atof(gt_input_get_value(input1)),limit);
	if(flag==2)
	{
		
		sprintf(buffer,"超限,%.2f~%.2f",limit.lowerlimit,limit.toplimit);
		gt_label_set_text(lab1, buffer);
		return;
	}
	else //如果没有超限制
	{
		
		sprintf(buffer,"%d",keyboardf.id);
		*keyboardf.data = atof(gt_input_get_value(input1));
		gt_event_send(gt_scr_stack_get_prev_scr(),MY_EVENT_UPDATA,buffer);
...
//create screen
gt_obj_st * gt_init_screen_keyBoard_float()
 {
	//receive the sent message
	char temp[50];

	enterkey = true;
	Screen_KeyBoard_Float = gt_obj_create(NULL);
	gt_screen_set_bgcolor(Screen_KeyBoard_Float, gt_color_hex(0x004040));
	...
	/** lab1 */
	lab1 = gt_label_create(Screen_KeyBoard_Float);
	gt_obj_set_pos(lab1, 4, 4);
	gt_obj_set_size(lab1, 280, 80);
	...
	sprintf(temp,"%s",keyboardf.title);
	gt_label_set_text(lab1, temp);

	
	
	/** headbar */
	rect1 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 2 */
	lab2 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** 2 */
	lab3 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** 3 */
	lab4 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** 4 */
	lab5 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** 5 */
	lab6 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** 6 */
	lab7 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** 7 */
	lab8 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** 8 */
	lab9 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** 9 */
	lab10 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** back */
	lab11 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** . */
	lab12 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** 0 */
	lab13 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** delete all */
	img1 = gt_img_create(Screen_KeyBoard_Float);
	gt_obj_set_pos(img1, 382, 160);
	gt_obj_set_size(img1, 50, 44);
	gt_img_set_src(img1, "f:img_55x45_40_dismiss_.png");


	/** delete one */
	img2 = gt_img_create(Screen_KeyBoard_Float);
	...
	/** confirm */
	lab14 = gt_label_create(Screen_KeyBoard_Float);
	...
	/** back */
	rect2 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 1 */
	rect3 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 2 */
	rect4 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 3 */
	rect5 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** delete one */
	rect6 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** . */
	rect7 = gt_rect_create(Screen_KeyBoard_Float);
	...
	gt_obj_add_event_cb(rect7, InputValue, GT_EVENT_TYPE_INPUT_RELEASED, ".");


	/** 4 */
	rect8 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 5 */
	rect9 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 6 */
	rect10 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** delete all */
	rect11 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 0 */
	rect12 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 7 */
	rect13 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 8 */
	rect14 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** 9 */
	rect15 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** ok */
	rect16 = gt_rect_create(Screen_KeyBoard_Float);
	...
	/** input1 */
	input1 = gt_input_create(Screen_KeyBoard_Float);
	...
	sprintf(temp,"%.2f",*keyboardf.data);
	gt_input_set_placeholder(input1,temp);
	gt_input_set_bg_color(input1, gt_color_hex(0xffffff));

	return Screen_KeyBoard_Float;
}
