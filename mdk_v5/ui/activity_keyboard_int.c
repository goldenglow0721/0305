...
/** Screen_KeyBoard_Int */
gt_obj_st * Screen_KeyBoard_Int = NULL;
...
static int JudgmentUPAndLowerLimitInt(int flData,Limit uintlimit)
{
	
	if(flData>=0)
	{
		if((flData>=uintlimit.lowerlimit)&&(flData<=uintlimit.toplimit))
		{
			return 0;
		}
		else 
...
static void Confirm(gt_event_st * e) {
	...
	char buffer[50];
	int flag;
	*keyboardi.data = atoi(gt_input_get_value(input1));
	flag = JudgmentUPAndLowerLimitInt(atoi(gt_input_get_value(input1)),limit);
	if(flag==2)
	{
...
//create screen
gt_obj_st * gt_init_Screen_KeyBoard_Int()
 {
	char temp[50];
	enterkey = true;
	
	Screen_KeyBoard_Int = gt_obj_create(NULL);
	gt_screen_set_bgcolor(Screen_KeyBoard_Int, gt_color_hex(0x004040));
	
	
	headvisiable(0);

	/** lab1 */
	lab1 = gt_label_create(Screen_KeyBoard_Int);
	...
	sprintf(temp,"%s",keyboardi.title);
	gt_label_set_text(lab1,temp);
	
	
	/** headbar */
	rect1 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 2 */
	lab2 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** 2 */
	lab3 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** 3 */
	lab4 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** 4 */
	lab5 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** 5 */
	lab6 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** 6 */
	lab7 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** 7 */
	lab8 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** 8 */
	lab9 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** 9 */
	lab10 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** back */
	lab11 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** . */
	lab12 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** 0 */
	lab13 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** delete all */
	img1 = gt_img_create(Screen_KeyBoard_Int);
	...
	/** delete one */
	img2 = gt_img_create(Screen_KeyBoard_Int);
	...
	/** confirm */
	lab14 = gt_label_create(Screen_KeyBoard_Int);
	...
	/** back */
	rect2 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 1 */
	rect3 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 2 */
	rect4 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 3 */
	rect5 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** delete one */
	rect6 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** . */
	rect7 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 4 */
	rect8 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 5 */
	rect9 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 6 */
	rect10 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** delete all */
	rect11 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 0 */
	rect12 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 7 */
	rect13 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 8 */
	rect14 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** 9 */
	rect15 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** ok */
	rect16 = gt_rect_create(Screen_KeyBoard_Int);
	...
	/** input1 */
	input1 = gt_input_create(Screen_KeyBoard_Int);
