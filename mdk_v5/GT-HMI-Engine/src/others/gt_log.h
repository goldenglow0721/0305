...
#ifndef GT_USE_VALUE_CHECK
    /**
     * @brief This function enables the value check feature.
     *      [default]: 1
     */
    #define GT_USE_VALUE_CHECK          01
#endif

#ifndef GT_USE_VALUE_CHECK_PRINT
    /**
     * @brief This function enables the value check print feature.
     *      [default]: 1
     */
    #define GT_USE_VALUE_CHECK_PRINT    01
#endif
...
/* value check ------------------------------------------------------------*/
    ...
    #define GT_CHECK_BACK(_value) do { \
            if (!_value) { GT_CHECK_PRINT(_value); return; } \
        }while(0)
    ...
    #define GT_CHECK_BACK_VAL(_value, _ret_code) do { \
            if (!_value) { GT_CHECK_PRINT(_value); return _ret_code; } \
        }while(0)
